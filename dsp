...
<nav>
  ...
  <a href="https://github.com/rayan-baderdine/portfolio.git" class="back-link">Back to Portfolio</a>
</nav>
...
<footer style="border-top:1px solid var(--border); padding:2rem 3rem; display:flex; justify-content:space-between; align-items:center; font-family:var(--font-mono); font-size:0.7rem; color:var(--muted); position:relative; z-index:1;">
  ...
  <a href="https://github.com/rayan-baderdine/portfolio.git" style="color:var(--accent3); text-decoration:none; font-size:0.7rem;">← Back to all projects</a>
</footer>
